...
;;;;;;  ede-project-autoload) "ede" "ede.el" (18328 37888))
...
;;;***

;;;### (autoloads (ede-cpp-root-project ede-cpp-root-load ede-cpp-root-project-root
;;;;;;  ede-cpp-root-project-file-for-dir) "ede-cpp-root" "ede-cpp-root.el"
;;;;;;  (18328 37888))
...
(add-to-list (quote ede-project-class-files) (ede-project-autoload "cpp-root" :name "CPP ROOT" :file (quote ede-cpp-root) :proj-file (quote ede-cpp-root-project-file-for-dir) :proj-root (quote ede-cpp-root-project-root) :load-type (quote ede-cpp-root-load) :class-sym (quote ede-cpp-root)) t)

(autoload (quote ede-cpp-root-project) "ede-cpp-root" "\
EDE cpp-root project class.
Each directory needs a a project file to control it.

\(fn EIEIO-INSTANCE-TRACKER EDE-PROJECT)" nil nil)
...
;;;***

;;;### (autoloads nil "ede-proj" "ede-proj.el" (18328 37888))
...
;;;;;;  "ede-simple" "ede-simple.el" (18328 37888))
...
;;;***

;;;### (autoloads (ede-update-version) "ede-util" "ede-util.el" (18328
;;;;;;  37888))
